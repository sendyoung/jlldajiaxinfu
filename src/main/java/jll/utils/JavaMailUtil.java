...
//    private String from = "youngsend@163.com"; // 发件人邮箱地址
//    private String user = "youngsend@163.com"; // 发件人称号，同邮箱地址
//    private String password = "cindy1116"; // 发件人邮箱客户端授权码

    public static boolean sendMail(String to, String text, String title){
        String from = "youngsend@163.com"; // 发件人邮箱地址
        String user = "youngsend@163.com"; // 发件人称号，同邮箱地址
        String password = "cindy1116"; // 发件人邮箱客户端授权码
