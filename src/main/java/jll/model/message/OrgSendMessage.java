 ...
 * 发送信表
 */
@Entity(name="org_send_message")
public class OrgSendMessage extends Base_Model {

    private String send_message_id;//发件主键
    ...
    public void setSend_message_id(String send_message_id) {
